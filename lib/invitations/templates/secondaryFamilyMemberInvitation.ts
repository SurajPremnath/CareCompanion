export const secondaryFamilyMemberInvitationTemplate = {
  subject: "CareVR Invitation — Secondary Family Member",

  body: [
    "You have been invited to CareVR as a Secondary Family Member.",
    "",
    "CareVR Web App:",
    "{{carevr_url}}",
    "",
