...
export default function RegenerateInvitationTokenPage() {
    ...
    const invitationLink =
        regenerationResult
            ? `${window.location.origin}/invitee-registration?token=${encodeURIComponent(
                regenerationResult.invitationToken
            )}`
            : "";


    //--------------------------------------------------------
    // Template with absolute registration URL
    //--------------------------------------------------------

    const invitationTemplateBody =
        regenerationResult
            ? regenerationResult.templateBody.replace(
                regenerationResult.templateBody.includes(
                    "/invitee-registration?"
                )
                    ? regenerationResult.templateBody.substring(
                        regenerationResult.templateBody.indexOf(
                            "/invitee-registration?"
                        ),
                        regenerationResult.templateBody.indexOf(
                            "\n",
                            ...
                            ? regenerationResult.templateBody.length
                            : regenerationResult.templateBody.indexOf(
                                "\n",
                                regenerationResult.templateBody.indexOf(
                                    "/invitee-registration?"
    ...
    const handleCopyToken =
        async () => {
            ...
            try {
                ...
                setError(
                    "Unable to copy the invitation token."
                );
        ...
        <main className="regenerate-invitation-page">
                ...
                <section className="regenerate-invitation-content">
                    ...
                    <div className="regenerate-card">
                        ...
                        <p className="regenerate-introduction">
                            Create a new secure invitation link
                            when the previous invitation was not
                            sent or has been lost.
                        </p>
            ...
            <style jsx global>{`
                ...
                * {
                ...
                .regenerate-details .regenerate-detail {
                    margin-bottom: 0;
                    padding: 13px;
