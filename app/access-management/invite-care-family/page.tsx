    ...
    const handleCopyTemporaryPassword =
        async () => {
            ...
            try {
                ...
                console.error(
                    "Unable to copy temporary password.",
                    error
                );
...
const handleCopyInvitationTemplate = async () => {
    if (!invitationTemplateSubject || !invitationTemplateBody) return;
    ...
    try {
        ...
        setInvitationTemplateCopied(true);
        setInvitationError(null);
    } catch (error) {
        console.error("Unable to copy invitation template.", error);
        setInvitationTemplateCopied(false);
        setInvitationError(
                                    ...
                                    <div className="invitee-email-input-wrap">
                                        ...
                                        <input
                                            ...
                                            onChange={event => {
                                                ...
                                                setTemporaryPasswordValue(null);
